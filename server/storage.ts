...
export class DatabaseStorage implements IStorage {
  ...
  async createUser(insertUser: InsertUser): Promise<User> {
    const id = randomUUID();
    // Creamos el objeto completo que vamos a insertar
    const newUser: User = { 
      ...insertUser, 
      id, 
      createdAt: new Date(),
      // Aseguramos que los campos opcionales tengan valor si es necesario, 
      // aunque en este caso insertUser ya trae lo necesario.
